...
def main():
    ...
    browser.get(f"https://www.instagram.com/p/{post_id}")
    sleep_for_period_of_time()

    #followers_link = browser.find_element_by_xpath("//ul/li[2]/a")
    followers_link = browser.find_element_by_css_selector("section._ae5m a")
    ...
    while(True):
        try:
            ...
            list_of_followers = browser.find_elements(By.CSS_SELECTOR, 'div._ab9s button._acan._acap._acas')
